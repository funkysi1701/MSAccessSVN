...
namespace AccessIO {
    ...
    /// </summary>
    public abstract class AccessObject: IObjecOptions {
        /// <summary>
        ...
        /// <summary>
        /// Gets the Options object associated with the specific AccessObject
        /// </summary>
        public virtual OptionsObj Options { get; set; }
